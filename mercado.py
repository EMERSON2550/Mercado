...
def cadastra_produto() -> None:
    print('Cadastro de protuto')
    print('===================')
    
    nome: str = input('Imfome o nome do produto:')
...
def listar_produto() -> None:
    if len(produtos) > 0:
        ...
        print('Ainda nao exitem produtos cadastrados')
    sleep(2)
    menu()
...
def fechar_pedido() -> None:
    if len(carrinho) > 0:
        ...
        print('Ainda nao exitem produtos no carrinho.')
    sleep(2)
    menu()
